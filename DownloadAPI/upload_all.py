...
MYSQL_USER = 'root'
MYSQL_PASSWORD = 'abcd' #Not the actual password
MYSQL_DATABASE = 'abcd' #Not the actual database name
...
def determine_column_type(series):
    """ Determine MySQL column type based on DataFrame column data. """
...
def escape_column_name(column_name):
    # List of MySQL reserved keywords
    reserved_keywords = {
        ...
        "BEFORE", "BEGIN", "BERNOULLI", "BETWEEN", "BIGINT", "BINARY", "BINLOG", "BIT",
        "BLOB", "BLOCK", "BOOL", "BOOLEAN", "BOTH", "BTREE", "BUCKETS", "BULK", "BY",
        "BYTE", "CACHE", "CALL", "CASCADE", "CASCADED", "CASE", "CATALOG_NAME", "CHAIN",
        "CHALLENGE_RESPONSE", "CHANGE", "CHANGED", "CHANNEL", "CHAR", "CHARACTER",
        ...
        "DUAL", "DUMPFILE", "DUPLICATE", "DYNAMIC", "EACH", "ELSE", "ELSEIF", "EMPTY",
        ...
        "EXTENT_SIZE", "FACTOR", "FAILED_LOGIN_ATTEMPTS", "FALSE", "FAST", "FAULTS",
        "FETCH", "FIELDS", "FILE", "FILE_BLOCK_SIZE", "FILTER", "FINISH", "FIRST",
        "FIRST_VALUE", "FIXED", "FLOAT", "FLOAT4", "FLOAT8", "FLUSH", "FOLLOWING",
        "FOLLOWS", "FOR", "FORCE", "FOREIGN", "FORMAT", "FOUND", "FROM", "FULL",
        "FULLTEXT", "FUNCTION", "GENERAL", "GENERATE", "GENERATED", "GEOMCOLLECTION",
        "GEOMETRY", "GEOMETRYCOLLECTION", "GET", "GET_FORMAT", "GET_SOURCE_PUBLIC_KEY",
        "GLOBAL", "GRANT", "GRANTS", "GROUP", "GROUPING", "GROUPS", "GROUP_REPLICATION",
        "GTIDS", "GTID_ONLY", "HANDLER", "HASH", "HAVING", "HELP", "HIGH_PRIORITY",
        "HISTOGRAM", "HISTORY", "HOST", "HOSTS", "HOUR", "HOUR_MICROSECOND",
        "HOUR_MINUTE", "HOUR_SECOND", "IDENTIFIED", "IF", "IGNORE", "IGNORE_SERVER_IDS",
        "IMPORT", "IN", "INACTIVE", "INDEX", "INDEXES", "INFILE", "INITIAL",
        "INITIAL_SIZE", "INITIATE", "INNER", "INOUT", "INSENSITIVE", "INSERT",
        "INSERT_METHOD", "INSTALL", "INSTANCE", "INT", "INT1", "INT2", "INT3",
        "INT4", "INT8", "INTEGER", "INTERSECT", "INTERVAL", "INTO", "INVISIBLE",
        "INVOKER", "IO", "IO_AFTER_GTIDS", "IO_BEFORE_GTIDS", "IO_THREAD", "IPC",
        "IS", "ISOLATION", "ISSUER", "ITERATE", "JOIN", "JSON", "JSON_TABLE",
        "JSON_VALUE", "KEY", "KEYRING", "KEYS", "KEY_BLOCK_SIZE", "KILL", "LAG",
        "LANGUAGE", "LAST", "LAST_VALUE", "LATERAL", "LEAD", "LEADING", "LEAVE",
        "LEAVES", "LEFT", "LESS", "LEVEL", "LIKE", "LIMIT", "LINEAR", "LINES",
        "LINESTRING", "LIST", "LOAD", "LOCAL", "LOCALTIME", "LOCALTIMESTAMP",
        "LOCK", "LOCKED", "LOCKS", "LOG", "LOGFILE", "LOGS", "LONG", "LONGBLOB",
        "LONGTEXT", "LOOP", "LOW_PRIORITY", "MANUAL", "MASTER", "MATCH", "MAXVALUE",
        ...
        "NAME", "NAMES", "NATIONAL", "NATURAL", "NCHAR", "NDB", "NDBCLUSTER",
        ...
        "PROCESSLIST", "PROFILE", "PROFILES", "PROXY", "PURGE", "QUALIFY",
        ...
        "REGISTRATION", "RELAY", "RELAYLOG", "RELAY_LOG_FILE", "RELAY_LOG_POS",
        "RELAY_THREAD", "RELEASE", "RELOAD", "REMOVE", "RENAME", "REORGANIZE",
        "REPAIR", "REPEAT", "REPEATABLE", "REPLACE", "REPLICA", "REPLICAS",
        ...
        "RESET", "RESIGNAL", "RESOURCE", "RESPECT", "RESTART", "RESTORE",
        "RESTRICT", "RESUME", "RETAIN", "RETURN", "RETURNED_SQLSTATE", "RETURNING",
        "RETURNS", "REUSE", "REVERSE", "REVOKE", "RIGHT", "RLIKE", "ROLE",
        "ROLLBACK", "ROLLUP", "ROTATE", "ROUTINE", "ROW", "ROWS", "ROW_COUNT",
        "ROW_FORMAT", "ROW_NUMBER", "RTREE", "S3", "SAVEPOINT", "SCHEDULE",
        "SCHEMA", "SCHEMAS", "SCHEMA_NAME", "SECOND", "SECONDARY",
        "SECONDARY_ENGINE", "SECONDARY_ENGINE_ATTRIBUTE", "SECONDARY_LOAD",
        "SECONDARY_UNLOAD", "SECOND_MICROSECOND", "SECURITY", "SELECT",
        "SENSITIVE", "SEPARATOR", "SERIAL", "SERIALIZABLE", "SERVER", "SESSION",
        "SET", "SHARE", "SHOW", "SHUTDOWN", "SIGNAL", "SIGNED", "SIMPLE",
        "SKIP", "SLAVE", "SLOW", "SMALLINT", "SNAPSHOT", "SOCKET", "SOME",
        "SONAME", "SOUNDS", "SOURCE", "SOURCE_AUTO_POSITION", "SOURCE_BIND",
        "SOURCE_COMPRESSION_ALGORITHMS", "SOURCE_CONNECT_RETRY", "SOURCE_DELAY",
        "SOURCE_HEARTBEAT_PERIOD", "SOURCE_HOST", "SOURCE_LOG_FILE",
        ...
        "SOURCE_TLS_VERSION", "SOURCE_USER", "SOURCE_ZSTD_COMPRESSION_LEVEL",
        ...
        "SQL_TSI_QUARTER", "SQL_TSI_SECOND", "SQL_TSI_WEEK", "SQL_TSI_YEAR", "SRID",
        ...
        "UNIQUE", "UNKNOWN", "UNLOCK", "UNREGISTER", "UNSIGNED", "UNTIL",
        "UPDATE", "UPGRADE", "URL", "USAGE", "USE", "USER", "USER_RESOURCES",
    ...
    # Check if the column_name is in the reserved keywords set
    if column_name.upper() in reserved_keywords:
        return f"_{column_name}"

    return column_name

def create_table_from_csv(cursor, table_name, df):
    """ Create a table and insert data from DataFrame into MySQL. """
    # Escape column names and determine column types
    columns_with_types = ', '.join([
        f"{escape_column_name(col)} {determine_column_type(df[col])}" for col in df.columns
    ])

    cols = [escape_column_name(col) for col in df.columns]
